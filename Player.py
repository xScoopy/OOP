class Player:
    ...
    def __init__(self, name):
        ...
        self.name = name
        self.current_hp = _starting_hp
        self.current_warmth = _starting_warmth
        self.current_hunger = _starting_hunger
        self.items = []
        self.location = "cabin"
    
    @classmethod
    def set_startinghp(cls, starting_value):
        """used to alter the starting hp for seasonal game modes"""
        cls._starting_hp = starting_value
    
    @classmethod
    def set_startinghunger(cls, starting_value):
        """used to alter starting hunger for seasonal game modes"""
